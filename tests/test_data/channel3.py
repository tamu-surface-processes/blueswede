...
NOTE: This code is *slightly* modified from the channel3 example included in
the ANUGA software distribution. 
"""
...
# ------------------------------------------------------------------------------
for t in domain.evolve(yieldstep=1, finaltime=25.0):
    domain.print_timestepping_statistics()

    stage_pt = domain.get_quantity("stage").get_values(
        interpolation_points=[[37.0, 2.5]]
    )
